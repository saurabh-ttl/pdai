...
def ask_question(sdf, query):
    ...
    # Check if the query contains the word "amount"
 
    
    # Return the original response if "amount" is not in the query
...
if prompt := st.chat_input("How may i help you?"):
    ...
    with st.chat_message("assistant"):
        ...
        # Modify the response to include 'Rs.' at the end
            
            st.markdown(str(response) + " Rs.")
        else:
    ...
    if "amount" in prompt.lower():
        # Modify the response to include 'Rs.' at the end
            ...
            st.session_state.messages.append({"role": "assistant", "content": str(response)+" Rs."})
    else:
